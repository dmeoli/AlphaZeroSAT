...
from GameSAT.common.misc_util import get_wrapper_by_name, SimpleMonitor, boolean_flag, set_global_seeds
from GameSAT.common.atari_wrappers_deprecated import wrap_dqn
...
if __name__ == '__main__':
    ...
    with U.make_session(4) as sess:  # noqa
        ...
        act = deepq.build_act(make_obs_ph=lambda name: U.Uint8Input(env.observation_space.shape, name=name),
